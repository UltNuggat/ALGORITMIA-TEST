# DEFINICIÓN DE CONEXIONES (distancias) ENTRE NODOS (CONEXIONES.GD)
...
# export significa que en el editor se pueden establecer distintos valores de conexiones y distancias para cada nodo
...
# Construye el array de distancias 
func _ready() -> void:
